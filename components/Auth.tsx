    ...
    <div className="fixed inset-0 bg-[#020617] flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter">EduPlanner Pro</h1>
          <p className="text-slate-400 mt-2 font-medium tracking-wide uppercase text-[10px]">Academic Architecture Cloud</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? (
                ...
                <>{isLogin ? 'Authorize Access' : 'Create Institution'}</>
              )}
            </button>
          </form>
        </div>
