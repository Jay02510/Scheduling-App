  ...
  if (!schedule || (schedule.weeklySlots.length === 0 && !editingSlot)) {
      return (
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center animate-fadeIn">
              ...
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest max-w-sm mb-8 leading-loose">The school schedule hasn't been initialized. Return to Setup or use manual editing below.</p>
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <button onClick={() => setSelectedClassId(classes[0]?.id || '')} className="bg-white text-indigo-600 border border-indigo-200 px-10 py-5 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-sm hover:bg-indigo-50 transition-all">Start Manual Grid</button>
              </div>
          </div>
      );
  }
