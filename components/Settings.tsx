  ...
  return (
    <div className="space-y-12 animate-fadeIn max-w-full overflow-hidden pb-20">
      <header>
        ...
        <p className="text-slate-500 font-medium text-sm mt-1">Manage institutional account.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">System Admin</p>
              </div>
            </div>
          </div>
          <button 
        ...
        <div className="bg-white p-10 rounded-[2.5rem] border-2 border-rose-50 shadow-sm space-y-8 flex flex-col justify-between">
          <div>
            <h3 className="text-[10px] font-black uppercase tracking-widest text-rose-400 mb-4">Critical Actions</h3>
            <h3 className="text-xl font-black text-slate-900 tracking-tight">Institutional Wipe</h3>
            <p className="text-slate-500 text-xs font-medium mt-2 leading-relaxed">
              Permanently clear all data, including faculty, classes, curriculum books, and generated schedules.
            </p>
          </div>
          <button 
            onClick={onReset} 
